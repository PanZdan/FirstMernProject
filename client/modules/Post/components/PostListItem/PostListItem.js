...
function PostListItem(props) {
  return (
    <div className={styles["single-post"]}>
      ...
      <p className={styles["author-name"]}>Votes: {props.post.votes}</p>
      <button onClick={props.handleThumbUpPost}>Like</button>
      <button onClick={props.handleThumbDownPost}>Dislike</button>
