  ...
  render() {
    return (
      <div>
        ...
        <PostList handleThumbUpPost={this.handleThumbUpPost} handleThumbDownPost={this.handleThumbDownPost} handleDeletePost={this.handleDeletePost} posts={this.props.posts} />
      </div>
    );
  }
}
